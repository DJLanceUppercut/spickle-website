...
export default function Gallery() {
  ...
  const description = 'Before and after gallery of stone cleaning and sealing results across Melbourne. Bluestone, limestone, granite, aggregate and more.'
  ...
  return (
    <>
      ...
      <Hero
        title="Before &amp; After"
        subtitle="Real results from real Melbourne jobs."
