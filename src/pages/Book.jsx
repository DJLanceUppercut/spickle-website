...
export default function Book() {
  useEffect(() => {
    document.title = 'Book Now | Spickle — Melbourne Stone Cleaning & Sealing'
    const desc = document.querySelector('meta[name="description"]')
    if (desc) desc.setAttribute('content', 'Book a stone cleaning or sealing job with Spickle. Serving all Melbourne suburbs. Quick response, professional results.')
    window.scrollTo(0, 0)
  }, [])
