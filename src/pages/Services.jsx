...
const serviceDetails = [
  {
    ...
    details: [
      { label: 'Method', text: 'Pressure cleaning with professional rotary and surface cleaners, combined with stone-specific alkaline or neutral cleaners applied at correct dwell times.' },
      ...
      { label: 'Suited to', text: 'All natural stone surfaces including bluestone, limestone, granite, travertine, slate, sandstone and porphyry, as well as exposed aggregate and concrete.' },
    ],
  },
  {
    title: 'Stone Sealing',
    intro: 'A quality sealer applied to clean stone is one of the best investments you can make in your outdoor surfaces. We use professional penetrating sealers from GuardIT Solutions, Lithofin and Environex that bond inside the stone rather than coating the surface.',
    details: [
  ...
  {
    title: 'Stain Removal',
    intro: 'Stubborn stains require targeted treatment, not harder scrubbing. We identify the stain chemistry and apply the appropriate professional product to break it down safely.',
    details: [
      ...
      { label: 'Mould & algae', text: 'Biological growth treated with a biodegradable biocide that kills at the root level, reducing rapid regrowth rather than just masking the surface.' },
      ...
      { label: 'Oil & grease', text: 'Hydrocarbon stains broken down with a professional degreaser and extraction. Old set-in stains may require a poultice treatment.' },
    ],
  },
]
